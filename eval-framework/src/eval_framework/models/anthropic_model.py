"""Anthropic Claude model implementation for the evaluation framework."""
...
class AnthropicModel(BaseModel[str, str]):
    """Anthropic Claude model implementation.
    
    This class provides an interface to Anthropic's Claude models with support for:
    - Different model types (Claude 2, Claude Instant, etc.)
    - Rate limiting
...
# Register the model
register_model("anthropic")(AnthropicModel) 